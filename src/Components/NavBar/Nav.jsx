...
flex flex-none items-center fixed top-0 left-0 right-0 dark:text-gray-100 dark:bg-nav_dark_bg_color duration-100 bg-Nav_Bg_Color   shadow-5xl z-50"
>
		...
		>
			...
			<nav className="flex   transition duration-300  flex-col space-y-2 py-4 border-t   ">
				...
				<button
					onClick={() => navigate("/resources")}
					type="button"
					className="text-sm font-medium flex items-center space-x-2 px-3 py-2 rounded   dark:bg-slate-900 text-gray-700  border border-transparent  
		hover:text-white  hover:bg-Nav_text_hover_color  dark:bg-nav_dark_bg_color  dark:text-gray-300 dark:border-none dark:hover:bg-slate-700 "
				>
					<AiTwotoneContacts />

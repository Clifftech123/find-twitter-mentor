...
//    USE Effect that handle  Light and Dark theme
	...
	// Event lister to listing to the system auto color preference
   ...
   return (
		<>
			...
			<nav>
				...
				<header
					id="page-header"
					className="flex flex-none items-center dark:text-gray-100 dark:bg-slate-900 duration-100 bg-white shadow-sm z-1"
				>
						...
						<div className="flex justify-between py-4">
							...
							<div className="flex items-center space-x-1 lg:space-x-5">
								...
								<div className="relative inline-block">
								  <div className="inline-flex justify-center items-center space-x-5  font-semibold focus:outline-none px-3 mr-10  md:ml-20 md:mr-0 py-2 leading-5 text-2xl rounded  bg-white text-gray-800    ">
									  {/* Looping through all the icons */}
										{options.map((opt) => (
											<button   onClick={()=> setTheme(opt.text)}  key={opt.text} className={`h-8 w-8 ${theme === opt.text && "text-sky-600" }  `} >
